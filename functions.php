...
function foundation_scripts_and_styles() {
	if ( ! is_admin() ) {
		...
		wp_enqueue_style( 'style-wow', get_template_directory_uri() . '/assets/scss/plugins/animate.css', null, null );/*2rd priority*/
		wp_enqueue_style( 'style', get_template_directory_uri() . '/style.css', null, null );/*1st priority*/
		wp_enqueue_style( 'swipeStyle', 'https://fonts.googleapis.com/css?family=Open+Sans:400,400i,700&display=swap', null, null );/*1st priority*/
		...
		wp_enqueue_script( 'slick', get_template_directory_uri() . '/assets/js/plugins/ScrollTrigger.min.js', null, '1.8.1', true );
...
//		wp_enqueue_script( 'fancybox.v2', get_template_directory_uri() . '/assets/js/plugins/jquery.fancybox.v2.js', null, '2.1.5', true );
		...
		wp_enqueue_script( 'swiper', 'https://unpkg.com/swiper@7/swiper-bundle.min.js', null, null, true );
		wp_enqueue_script( 'gsap', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.8.0/gsap.min.js', null, null, true );
		wp_enqueue_script( 'ScrollTrigger', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.8.0/ScrollTrigger.min.js', null, null, true );
		wp_enqueue_script( 'js-wow', get_template_directory_uri() . '/assets/js/plugins/wow.min.js', null, '12.4.0', true );
